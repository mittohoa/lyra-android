...
/**
 * Dong tu xung gui ra ngoai la thu duy nhat mang ten AURA roi khoi may nguoi
 * dung, nen no phai dung so hieu va tuyet doi khong kem gi cua nguoi dung.
 */
class DanhTinhTest {

    @Test fun `mang dung so hieu ban dang chay`() {
        // Truoc day go tay "AURA/0.1.0" va "AURA/1.0" trong khi app da 0.3.4.
    ...
    @Test fun `khong kem gi cua nguoi dung`() {
        ...
        assertEquals("AURA/ (https://mittohoa.github.io/lyra-player/)", chuaSoHieu)
    }
}
